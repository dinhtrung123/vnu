...
/**
 * Provides the local service interface for Nhom. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author nhanvienDTT
 * @see NhomLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NhomLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NhomLocalServiceUtil} to access the nhom local service. Add custom service methods to <code>org.oep.danhmuc.service.impl.NhomLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
