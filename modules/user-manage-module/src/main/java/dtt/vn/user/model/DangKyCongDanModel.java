...
public class DangKyCongDanModel {
	String email,userName, password, hoTen, ngaySinh, diaChiChiTiet, soCMND, dienThoai, daYeuTo;
	long gioiTinhId, tinhId, quanHuyenId, phuongXaId;
