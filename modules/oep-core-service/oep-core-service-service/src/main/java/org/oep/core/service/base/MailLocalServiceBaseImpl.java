...
import org.oep.core.service.MailLocalService;
...
/**
 * Provides the base implementation for the mail local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.core.service.impl.MailLocalServiceImpl}.
 * </p>
 *
 * @author manhlb
 * @see org.oep.core.service.impl.MailLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class MailLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements MailLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MailLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>org.oep.core.service.MailLocalServiceUtil</code>.
	 */
	...
	public Mail addMail(Mail mail) {
		...
		return mailPersistence.update(mail);
	}
	...
	public Mail createMail(long id) {
		return mailPersistence.create(id);
	}
	...
	public Mail deleteMail(long id) throws PortalException {
		return mailPersistence.remove(id);
	}
	...
	public Mail deleteMail(Mail mail) {
		return mailPersistence.remove(mail);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Mail.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return mailPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return mailPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return mailPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return mailPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return mailPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Mail fetchMail(long id) {
		return mailPersistence.fetchByPrimaryKey(id);
	}
	...
	public Mail getMail(long id) throws PortalException {
		return mailPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(mailLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Mail.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(mailLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Mail.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return mailLocalService.deleteMail((Mail)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return mailPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Mail> getMails(int start, int end) {
		return mailPersistence.findAll(start, end);
	}
	...
	public int getMailsCount() {
		return mailPersistence.countAll();
	}
	 ...
	 */
	public void setMailLocalService(MailLocalService mailLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"org.oep.core.model.Mail", mailLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.oep.core.model.Mail");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MailLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = mailPersistence.getDataSource();
	...
	@BeanReference(type = MailLocalService.class)
	protected MailLocalService mailLocalService;
