...
import org.oep.core.service.PhanQuyenLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.core.service.impl.PhanQuyenLocalServiceImpl}.
 * </p>
 *
 * @author manhlb
 * @see org.oep.core.service.impl.PhanQuyenLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class PhanQuyenLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements PhanQuyenLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PhanQuyenLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>org.oep.core.service.PhanQuyenLocalServiceUtil</code>.
	 */
	...
	public PhanQuyen createPhanQuyen(long id) {
		return phanQuyenPersistence.create(id);
	}
	...
	public PhanQuyen deletePhanQuyen(long id) throws PortalException {
		return phanQuyenPersistence.remove(id);
	}
	...
	public PhanQuyen deletePhanQuyen(PhanQuyen phanQuyen) {
		return phanQuyenPersistence.remove(phanQuyen);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PhanQuyen.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return phanQuyenPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return phanQuyenPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return phanQuyenPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return phanQuyenPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PhanQuyen fetchPhanQuyen(long id) {
		return phanQuyenPersistence.fetchByPrimaryKey(id);
	}
	...
	public PhanQuyen getPhanQuyen(long id) throws PortalException {
		return phanQuyenPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(phanQuyenLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PhanQuyen.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			phanQuyenLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PhanQuyen.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return phanQuyenLocalService.deletePhanQuyen((PhanQuyen)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return phanQuyenPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PhanQuyen> getPhanQuyens(int start, int end) {
		return phanQuyenPersistence.findAll(start, end);
	}
	...
	public int getPhanQuyensCount() {
		return phanQuyenPersistence.countAll();
	}
	 ...
	 */
	public PhanQuyenLocalService getPhanQuyenLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"org.oep.core.model.PhanQuyen", phanQuyenLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.oep.core.model.PhanQuyen");
	}
	...
	public String getOSGiServiceIdentifier() {
		return PhanQuyenLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = phanQuyenPersistence.getDataSource();
	...
	@BeanReference(type = PhanQuyenLocalService.class)
	protected PhanQuyenLocalService phanQuyenLocalService;
