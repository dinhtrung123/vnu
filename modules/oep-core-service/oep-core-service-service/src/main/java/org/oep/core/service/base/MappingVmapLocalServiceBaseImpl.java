...
import org.oep.core.service.MappingVmapLocalService;
...
/**
 * Provides the base implementation for the mapping vmap local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.core.service.impl.MappingVmapLocalServiceImpl}.
 * </p>
 *
 * @author manhlb
 * @see org.oep.core.service.impl.MappingVmapLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class MappingVmapLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements MappingVmapLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MappingVmapLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>org.oep.core.service.MappingVmapLocalServiceUtil</code>.
	 */
	...
	public MappingVmap addMappingVmap(MappingVmap mappingVmap) {
		...
		return mappingVmapPersistence.update(mappingVmap);
	}
	...
	public MappingVmap createMappingVmap(long id) {
		return mappingVmapPersistence.create(id);
	}
	...
	public MappingVmap deleteMappingVmap(long id) throws PortalException {
		return mappingVmapPersistence.remove(id);
	}
	...
	public MappingVmap deleteMappingVmap(MappingVmap mappingVmap) {
		return mappingVmapPersistence.remove(mappingVmap);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MappingVmap.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return mappingVmapPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return mappingVmapPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return mappingVmapPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return mappingVmapPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MappingVmap fetchMappingVmap(long id) {
		return mappingVmapPersistence.fetchByPrimaryKey(id);
	}
	...
	public MappingVmap getMappingVmap(long id) throws PortalException {
		return mappingVmapPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(mappingVmapLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MappingVmap.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(MappingVmap.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return mappingVmapLocalService.deleteMappingVmap(
			(MappingVmap)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return mappingVmapPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MappingVmap> getMappingVmaps(int start, int end) {
		return mappingVmapPersistence.findAll(start, end);
	}
	...
	public int getMappingVmapsCount() {
		return mappingVmapPersistence.countAll();
	}
	 ...
	 */
	public MappingVmapLocalService getMappingVmapLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"org.oep.core.model.MappingVmap", mappingVmapLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.oep.core.model.MappingVmap");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MappingVmapLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = mappingVmapPersistence.getDataSource();
	...
	@BeanReference(type = MappingVmapLocalService.class)
	protected MappingVmapLocalService mappingVmapLocalService;
