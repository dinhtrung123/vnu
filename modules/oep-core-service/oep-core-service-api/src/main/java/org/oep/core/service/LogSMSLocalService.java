...
/**
 * Provides the local service interface for LogSMS. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author manhlb
 * @see LogSMSLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LogSMSLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LogSMSLocalServiceUtil} to access the log sms local service. Add custom service methods to <code>org.oep.core.service.impl.LogSMSLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public LogSMS addLogSMS(LogSMS logSMS);
	...
	public LogSMS createLogSMS(long id);
	...
	public LogSMS deleteLogSMS(LogSMS logSMS);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public LogSMS deleteLogSMS(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LogSMS fetchLogSMS(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LogSMS getLogSMS(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LogSMS> getLogSMSs(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LogSMS> searchByPhone(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public LogSMS updateLogSMS(LogSMS logSMS);
