...
/**
 * Provides the local service interface for MappingVmap. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author manhlb
 * @see MappingVmapLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MappingVmapLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MappingVmapLocalServiceUtil} to access the mapping vmap local service. Add custom service methods to <code>org.oep.core.service.impl.MappingVmapLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public MappingVmap addMapping(
	...
	public MappingVmap addMappingVmap(MappingVmap mappingVmap);
	...
	public MappingVmap createMappingVmap(long id);
	...
	public MappingVmap deleteMappingVmap(long id) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public MappingVmap deleteMappingVmap(MappingVmap mappingVmap);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MappingVmap fetchMappingVmap(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MappingVmap getMappingVmap(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MappingVmap> getMappingVmaps(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public MappingVmap updateMappingVmap(MappingVmap mappingVmap);

	public MappingVmap updateToaDo(
		String classname, long classpk, String latitude, String longitude,
		String ghichu);
