...
/**
 * Provides the local service interface for Mail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author manhlb
 * @see MailLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MailLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MailLocalServiceUtil} to access the mail local service. Add custom service methods to <code>org.oep.core.service.impl.MailLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public Mail createMail(long id);
	...
	public Mail deleteMail(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Mail getMail(long id) throws PortalException;
