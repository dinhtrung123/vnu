...
/**
 * The persistence interface for the log sms service.
 *
 * <p>
 ...
 */
@ProviderType
public interface LogSMSPersistence extends BasePersistence<LogSMS> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LogSMSUtil} to access the log sms persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	@Override
	 ...
	 */
	public void cacheResult(java.util.List<LogSMS> logSMSs);
	 ...
	 */
	public java.util.List<LogSMS> findAll();
	 ...
	 */
	public java.util.List<LogSMS> findAll(int start, int end);
	...
	public java.util.List<LogSMS> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<LogSMS>
			orderByComparator);
