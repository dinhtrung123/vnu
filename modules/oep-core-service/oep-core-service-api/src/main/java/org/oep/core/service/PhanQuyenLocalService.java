...
public interface PhanQuyenLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PhanQuyenLocalServiceUtil} to access the phan quyen local service. Add custom service methods to <code>org.oep.core.service.impl.PhanQuyenLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public PhanQuyen createPhanQuyen(long id);
	...
	public PhanQuyen deletePhanQuyen(long id) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public PhanQuyen deletePhanQuyen(PhanQuyen phanQuyen);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PhanQuyen fetchPhanQuyen(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PhanQuyen getPhanQuyen(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PhanQuyen> getPhanQuyens(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PhanQuyen updatePhanQuyen(PhanQuyen phanQuyen);
