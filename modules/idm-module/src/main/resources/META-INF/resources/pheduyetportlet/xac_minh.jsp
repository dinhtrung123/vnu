	...
	<aui:form name="fm" action="<%=pheDuyetURL %>" method="post">
		...
		<aui:input name="<%=Constants.CMD%>" type="hidden" />
			<aui:button-row >
					...
					<aui:button type="button" value="Phê duyệt" 	onClick='<%= renderResponse.getNamespace() + "saveXacMinh()" %>' cssClass="btn-primary" />
					<aui:button type="button" value="Yêu cầu xác minh lại" 	onClick='<%= renderResponse.getNamespace() + "saveKhongXacMinh()" %>' cssClass="btn-primary"/>
