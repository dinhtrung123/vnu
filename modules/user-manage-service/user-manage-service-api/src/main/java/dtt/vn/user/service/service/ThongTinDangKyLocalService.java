...
/**
 * Provides the local service interface for ThongTinDangKy. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author nhanvienDTT
 * @see ThongTinDangKyLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ThongTinDangKyLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ThongTinDangKyLocalServiceUtil} to access the thong tin dang ky local service. Add custom service methods to <code>dtt.vn.user.service.service.impl.ThongTinDangKyLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public ThongTinDangKy addThongTinDangKy(
			String emailAddress, String userName, String soGiayTo,
			String maKichHoat, int doiTuongSuDungId, String noiDung,
			String activeType, Date ngayTao)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ThongTinDangKy getByActiveType(String activeType)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ThongTinDangKy getByEmailAddress(String emailAddress)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ThongTinDangKy getByMaKichHoat(String maKichHoat)
		throws SystemException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ThongTinDangKy> searchByEmailOrUsername(
