...
/**
 * Provides the local service interface for DataImport. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author nhanvienDTT
 * @see DataImportLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DataImportLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DataImportLocalServiceUtil} to access the data import local service. Add custom service methods to <code>dtt.vn.user.service.service.impl.DataImportLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DataImport> searchForImport(
		int hasImport, String screenName, String lastName, String email,
