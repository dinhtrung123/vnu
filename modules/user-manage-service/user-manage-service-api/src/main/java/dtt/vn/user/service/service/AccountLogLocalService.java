...
/**
 * Provides the local service interface for AccountLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author nhanvienDTT
 * @see AccountLogLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AccountLogLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AccountLogLocalServiceUtil} to access the account log local service. Add custom service methods to <code>dtt.vn.user.service.service.impl.AccountLogLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public AccountLog addAccountLog(
			long accountId, long nguoiSuaId, String tenNguoiSua,
			String emailNguoiSua, Date ngaySua, long phienBan, String json)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AccountLog> getByAccount(long accountId, int start, int end)
		throws SystemException;
