...
/**
 * Provides the local service interface for ThongTinCanBo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author nhanvienDTT
 * @see ThongTinCanBoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ThongTinCanBoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ThongTinCanBoLocalServiceUtil} to access the thong tin can bo local service. Add custom service methods to <code>dtt.vn.user.service.service.impl.ThongTinCanBoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public ThongTinCanBo addThongTinCanBo(
	...
	public ThongTinCanBo addThongTinCanBo(ThongTinCanBo thongTinCanBo);
	...
	public ThongTinCanBo createThongTinCanBo(long id);
	...
	public ThongTinCanBo deleteThongTinCanBo(long id) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ThongTinCanBo deleteThongTinCanBo(ThongTinCanBo thongTinCanBo);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ThongTinCanBo fetchThongTinCanBo(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ThongTinCanBo getThongTinCanBo(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ThongTinCanBo> getThongTinCanBos(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ThongTinCanBo updateThongTinCanBo(ThongTinCanBo thongTinCanBo);
