...
import dtt.vn.user.service.service.DataImportService;
...
/**
 * Provides the base implementation for the data import remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link dtt.vn.user.service.service.impl.DataImportServiceImpl}.
 * </p>
 *
 * @author nhanvienDTT
 * @see dtt.vn.user.service.service.impl.DataImportServiceImpl
 * @generated
 */
public abstract class DataImportServiceBaseImpl
	extends BaseServiceImpl
	implements DataImportService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DataImportService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>dtt.vn.user.service.service.DataImportServiceUtil</code>.
	 */
	...
	public String getOSGiServiceIdentifier() {
		return DataImportService.class.getName();
	}
	...
	@BeanReference(type = DataImportService.class)
