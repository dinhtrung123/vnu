...
import dtt.vn.user.service.service.DoiTuongSuDungService;
...
/**
 * Provides the base implementation for the doi tuong su dung remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link dtt.vn.user.service.service.impl.DoiTuongSuDungServiceImpl}.
 * </p>
 *
 * @author nhanvienDTT
 * @see dtt.vn.user.service.service.impl.DoiTuongSuDungServiceImpl
 * @generated
 */
public abstract class DoiTuongSuDungServiceBaseImpl
	extends BaseServiceImpl
	implements DoiTuongSuDungService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DoiTuongSuDungService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>dtt.vn.user.service.service.DoiTuongSuDungServiceUtil</code>.
	 */
	 ...
	 */
	public DoiTuongSuDungService getDoiTuongSuDungService() {
	 ...
	 */
	public dtt.vn.user.service.service.ThongTinDangKyService
		getThongTinDangKyService() {
	...
	public void setThongTinDangKyService(
		dtt.vn.user.service.service.ThongTinDangKyService
			thongTinDangKyService) {
	...
	public String getOSGiServiceIdentifier() {
		return DoiTuongSuDungService.class.getName();
	}
	...
	@BeanReference(type = DoiTuongSuDungService.class)
	protected DoiTuongSuDungService doiTuongSuDungService;
	...
	@BeanReference(
		type = dtt.vn.user.service.service.ThongTinDangKyService.class
	)
	protected dtt.vn.user.service.service.ThongTinDangKyService
		thongTinDangKyService;
