...
import dtt.vn.user.service.service.DoiTuongSuDungLocalService;
...
/**
 * Provides the base implementation for the doi tuong su dung local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link dtt.vn.user.service.service.impl.DoiTuongSuDungLocalServiceImpl}.
 * </p>
 *
 * @author nhanvienDTT
 * @see dtt.vn.user.service.service.impl.DoiTuongSuDungLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class DoiTuongSuDungLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements DoiTuongSuDungLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DoiTuongSuDungLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>dtt.vn.user.service.service.DoiTuongSuDungLocalServiceUtil</code>.
	 */
	...
	public DoiTuongSuDung addDoiTuongSuDung(DoiTuongSuDung doiTuongSuDung) {
		...
		return doiTuongSuDungPersistence.update(doiTuongSuDung);
	}
	...
	public DoiTuongSuDung createDoiTuongSuDung(long id) {
		return doiTuongSuDungPersistence.create(id);
	}
	...
	public DoiTuongSuDung deleteDoiTuongSuDung(long id) throws PortalException {
		return doiTuongSuDungPersistence.remove(id);
	}
	...
	public DoiTuongSuDung deleteDoiTuongSuDung(DoiTuongSuDung doiTuongSuDung) {
		return doiTuongSuDungPersistence.remove(doiTuongSuDung);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DoiTuongSuDung.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return doiTuongSuDungPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return doiTuongSuDungPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return doiTuongSuDungPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return doiTuongSuDungPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DoiTuongSuDung fetchDoiTuongSuDung(long id) {
		return doiTuongSuDungPersistence.fetchByPrimaryKey(id);
	}
	...
	public DoiTuongSuDung getDoiTuongSuDung(long id) throws PortalException {
		return doiTuongSuDungPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(doiTuongSuDungLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DoiTuongSuDung.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DoiTuongSuDung.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return doiTuongSuDungLocalService.deleteDoiTuongSuDung(
			(DoiTuongSuDung)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return doiTuongSuDungPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DoiTuongSuDung> getDoiTuongSuDungs(int start, int end) {
		return doiTuongSuDungPersistence.findAll(start, end);
	}
	...
	public int getDoiTuongSuDungsCount() {
		return doiTuongSuDungPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"dtt.vn.user.service.model.DoiTuongSuDung",
			doiTuongSuDungLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DoiTuongSuDungLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = doiTuongSuDungPersistence.getDataSource();
