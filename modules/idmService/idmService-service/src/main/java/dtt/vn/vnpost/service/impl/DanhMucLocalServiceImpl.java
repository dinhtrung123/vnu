...
import dtt.vn.vnpost.service.base.DanhMucLocalServiceBaseImpl;

/**
 * The implementation of the danh muc local service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>dtt.vn.vnpost.service.DanhMucLocalService</code> interface.
 *
 * <p>
...
public class DanhMucLocalServiceImpl extends DanhMucLocalServiceBaseImpl {
	...
	public DanhMuc getDanhMuc_By_Nhom_Muc_Ten(String maNhom, int level, String ten, boolean isActive) throws SystemException{
		Nhom nhom = nhomPersistence.fetchByMa(maNhom);
		if(nhom != null){
