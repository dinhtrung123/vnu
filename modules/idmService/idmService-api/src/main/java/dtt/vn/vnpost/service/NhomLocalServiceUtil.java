 ...
 * <code>dtt.vn.vnpost.service.impl.NhomLocalServiceImpl</code> and
...
public class NhomLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>dtt.vn.vnpost.service.impl.NhomLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static dtt.vn.vnpost.model.Nhom addNhom(
		dtt.vn.vnpost.model.Nhom nhom) {
	 ...
	 * @return the new nhom
	 */
	public static dtt.vn.vnpost.model.Nhom createNhom(long id) {
	 ...
	 */
	public static dtt.vn.vnpost.model.Nhom deleteNhom(long id)
	 ...
	 * @return the nhom that was removed
	 */
	public static dtt.vn.vnpost.model.Nhom deleteNhom(
		dtt.vn.vnpost.model.Nhom nhom) {
	...
	public static dtt.vn.vnpost.model.Nhom fetchNhom(long id) {
	 ...
	 * @throws PortalException if a nhom with the primary key could not be found
	 */
	public static dtt.vn.vnpost.model.Nhom getNhom(long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getNhom(id);
	}

	public static dtt.vn.vnpost.model.Nhom getNhomByMa(String maNhom)
	 ...
	 */
	public static java.util.List<dtt.vn.vnpost.model.Nhom> getNhoms(
		int start, int end) {
	 ...
	 */
	public static dtt.vn.vnpost.model.Nhom updateNhom(
		dtt.vn.vnpost.model.Nhom nhom) {
