...
/**
 * Provides the local service interface for WorkItem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see WorkItemLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface WorkItemLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WorkItemLocalServiceUtil} to access the work item local service. Add custom service methods to <code>dtt.vn.vnpost.service.impl.WorkItemLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WorkItem> getQuaTrinhXuLy(long accountId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WorkItem getWorkItemByAccountId(long accountId)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WorkItem getWorkItemByAccountIdLastComplete(long accountId)
		throws SystemException;
