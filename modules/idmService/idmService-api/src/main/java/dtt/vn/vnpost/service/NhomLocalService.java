...
public interface NhomLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NhomLocalServiceUtil} to access the nhom local service. Add custom service methods to <code>dtt.vn.vnpost.service.impl.NhomLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
