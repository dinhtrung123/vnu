...
public interface AccountLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AccountLocalServiceUtil} to access the account local service. Add custom service methods to <code>dtt.vn.vnpost.service.impl.AccountLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Account> searchAccountForAPI(
		String keyword, int tinhtrang, String email, String userName,
		String fullName, String telNo, int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Account> searchForDanhSach(
		String keyword, int hinhthucdangky, String sogiayto, String tungay,
		String denngay, String sodienthoai, String tentaikhoan,
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Account> searchForPheDuyet(
		String keyword, int tinhtrang, String email, String sogiayto,
		String tungay, String denngay, String sodienthoai, String tentaikhoan,
		int loaidoituong, int hinhthucdangky, int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Account> searchForXacMinh(
		String keyword, int tinhtrang, String email, String sogiayto,
		String tungay, String denngay, String sodienthoai, String tentaikhoan,
		int loaidoituong, int hinhthucdangky, int start, int end);

	public Account themMoi(
		long companyId, long groupId, long userId, Date createDate,
		Date modifiedDate, String message, int accountStatus, int processStatus,
		int accountType, String accountName, String legalDelegate,
		String fullName, int gender, Date birthdate, String address,
		String email, String personalId, String telNo, String tinhId,
		String huyenId, String xaId, int ipLevel, String taxCode);
