...
public interface DanhMucLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DanhMucLocalServiceUtil} to access the danh muc local service. Add custom service methods to <code>dtt.vn.vnpost.service.impl.DanhMucLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
