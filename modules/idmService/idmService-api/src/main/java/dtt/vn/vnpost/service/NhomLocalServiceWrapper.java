...
public class NhomLocalServiceWrapper
	 ...
	 */
	@Override
	public dtt.vn.vnpost.model.Nhom addNhom(dtt.vn.vnpost.model.Nhom nhom) {
	 ...
	 */
	@Override
	public dtt.vn.vnpost.model.Nhom createNhom(long id) {
	 ...
	 */
	@Override
	public dtt.vn.vnpost.model.Nhom deleteNhom(long id)
	 ...
	 */
	@Override
	public dtt.vn.vnpost.model.Nhom deleteNhom(dtt.vn.vnpost.model.Nhom nhom) {
	...
	@Override
	public dtt.vn.vnpost.model.Nhom fetchNhom(long id) {
	 ...
	 */
	@Override
	public dtt.vn.vnpost.model.Nhom getNhom(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public dtt.vn.vnpost.model.Nhom getNhomByMa(String maNhom)
	 ...
	 */
	@Override
	public java.util.List<dtt.vn.vnpost.model.Nhom> getNhoms(
		int start, int end) {
	 ...
	 */
	@Override
	public dtt.vn.vnpost.model.Nhom updateNhom(dtt.vn.vnpost.model.Nhom nhom) {
