...
import dtt.vn.audit.exception.NoSuchAuditEventException;
import dtt.vn.audit.model.AuditEvent;
import dtt.vn.audit.model.impl.AuditEventImpl;
import dtt.vn.audit.model.impl.AuditEventModelImpl;
...
public class AuditEventPersistenceImpl
	 ...
	 * @throws NoSuchAuditEventException if a matching audit event could not be found
	 */
	@Override
	public AuditEvent findByCompanyId_First(
		...
		throw new NoSuchAuditEventException(msg.toString());
	}
	 ...
	 * @throws NoSuchAuditEventException if a audit event with the primary key could not be found
	 */
	@Override
	...
	public AuditEvent remove(Serializable primaryKey)
		...
		catch (NoSuchAuditEventException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	/**
	 * Returns the audit event with the primary key or throws a <code>NoSuchAuditEventException</code> if it could not be found.
	 *
	 * @param auditEventId the primary key of the audit event
	 * @return the audit event
	 * @throws NoSuchAuditEventException if a audit event with the primary key could not be found
