...
public class AuditEventWrapper implements AuditEvent, ModelWrapper<AuditEvent> {
	...
	@Override
	public int compareTo(dtt.vn.audit.model.AuditEvent auditEvent) {
	...
	public com.liferay.portal.kernel.model.CacheModel
		<dtt.vn.audit.model.AuditEvent> toCacheModel() {

		return _auditEvent.toCacheModel();
	}

	@Override
	public dtt.vn.audit.model.AuditEvent toEscapedModel() {
	...
	@Override
	public dtt.vn.audit.model.AuditEvent toUnescapedModel() {
