...
/**
 * The persistence utility for the audit event service. This utility wraps <code>dtt.vn.audit.service.persistence.impl.AuditEventPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class AuditEventUtil {
	...
	public static AuditEvent findByCompanyId_First(
		...
		throws dtt.vn.audit.exception.NoSuchAuditEventException {
