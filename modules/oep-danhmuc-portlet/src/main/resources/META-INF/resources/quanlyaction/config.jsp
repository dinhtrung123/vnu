...
<%@page import="org.oep.danhmuc.portlet.quanly.configuration.QuanLyConfiguration"%>
...
<%@ include file="/quanlyaction/init.jsp" %>
 ...
 <%
 QuanLyConfiguration quanLyConfiguration =(QuanLyConfiguration) renderRequest.getAttribute(QuanLyConfiguration.class.getName());
	List<Nhom> listNhoms = NhomLocalServiceUtil.getNhoms(QueryUtil.ALL_POS, QueryUtil.ALL_POS);
	PortletPreferences prefs = renderRequest.getPreferences();
	String groupIds = prefs.getValue(QuanLyKeys.Prefs.NHOM_DANH_MUC, quanLyConfiguration.getNhomDanhMuc());
